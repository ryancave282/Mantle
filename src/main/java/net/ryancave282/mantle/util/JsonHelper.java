package net.ryancave282.mantle.util;
...
import net.ryancave282.mantle.data.loadable.common.BlockStateLoadable;
import net.ryancave282.mantle.network.NetworkWrapper;
import net.ryancave282.mantle.network.packet.ISimplePacket;
...
public class JsonHelper {
  ...
  /** @deprecated use {@link BlockStateLoadable} with {@link Loadable#convert(JsonElement, String)} */
  ...
  /** @deprecated use {@link BlockStateLoadable#DIFFERENCE} with {@link Loadable#getIfPresent(JsonObject, String)} */
  @Deprecated(forRemoval = true)
  ...
  /** @deprecated use {@link BlockStateLoadable#DIFFERENCE} with {@link RecordLoadable#deserialize(JsonObject)} */
  @Deprecated(forRemoval = true)
  public static BlockState convertToBlockState(JsonObject json) {
    return BlockStateLoadable.DIFFERENCE.deserialize(json);
  }

  /** @deprecated use {@link BlockStateLoadable#DIFFERENCE} with {@link Loadable#serialize(Object)}*/
  @Deprecated(forRemoval = true)
  public static JsonElement serializeBlockState(BlockState state) {
    return BlockStateLoadable.DIFFERENCE.serialize(state);
  }

  /** @deprecated use {@link BlockStateLoadable#DIFFERENCE} with {@link RecordLoadable#serialize(Object, JsonObject)} */
  @Deprecated(forRemoval = true)
