package net.ryancave282.mantle.plugin.jei.entity;
...
import net.ryancave282.mantle.plugin.jei.MantleJEIConstants;
import net.ryancave282.mantle.recipe.ingredient.EntityIngredient;
