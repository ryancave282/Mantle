...
import net.ryancave282.mantle.client.screen.MultiModuleScreen;
import net.ryancave282.mantle.inventory.MultiModuleContainerMenu;
import net.ryancave282.mantle.plugin.jei.entity.EntityIngredientHelper;
import net.ryancave282.mantle.plugin.jei.entity.EntityIngredientRenderer;
