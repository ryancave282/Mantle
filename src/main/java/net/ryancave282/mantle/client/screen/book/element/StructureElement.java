...
import net.ryancave282.mantle.client.book.structure.StructureInfo;
import net.ryancave282.mantle.client.book.structure.level.TemplateLevel;
import net.ryancave282.mantle.client.render.MantleRenderTypes;
