package net.ryancave282.mantle.client.screen.book.element;

import net.minecraft.client.gui.Font;
import net.minecraft.client.gui.GuiGraphics;
import net.minecraft.network.chat.Component;
import net.ryancave282.mantle.client.book.action.StringActionProcessor;
import net.ryancave282.mantle.client.book.data.element.TextComponentData;
import net.ryancave282.mantle.client.screen.book.TextComponentDataRenderer;
