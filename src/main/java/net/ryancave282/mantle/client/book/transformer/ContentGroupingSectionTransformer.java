package net.ryancave282.mantle.client.book.transformer;
...
import net.ryancave282.mantle.client.book.data.PageData;
import net.ryancave282.mantle.client.book.data.SectionData;
import net.ryancave282.mantle.client.book.data.content.ContentListing;
import net.ryancave282.mantle.client.book.data.content.ContentPadding.ContentRightPadding;
import net.ryancave282.mantle.client.screen.book.BookScreen;
import net.ryancave282.mantle.client.screen.book.TextDataRenderer;
