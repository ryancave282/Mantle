package net.ryancave282.mantle.client.book.data;
...
import net.ryancave282.mantle.client.book.data.content.ContentError;
import net.ryancave282.mantle.client.book.data.content.PageContent;
import net.ryancave282.mantle.client.book.data.element.IDataElement;
import net.ryancave282.mantle.client.book.repository.BookRepository;
import net.ryancave282.mantle.util.DataLoadedConditionContext;
