...
import net.ryancave282.mantle.client.book.data.content.ContentPadding.PaddingBookTransformer;
import net.ryancave282.mantle.client.book.data.content.ContentTableOfContents;
