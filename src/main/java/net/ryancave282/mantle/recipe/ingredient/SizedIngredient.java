package net.ryancave282.mantle.recipe.ingredient;
...
import net.ryancave282.mantle.data.loadable.common.IngredientLoadable;
...
public class SizedIngredient implements Predicate<ItemStack> {
  ...
  /** use {@link #LOADABLE} with {@link Loadable#encode(FriendlyByteBuf, Object)} */
  @Deprecated(forRemoval = true)
  public void write(FriendlyByteBuf buffer) {
    LOADABLE.encode(buffer, this);
  }

  /** @deprecated use {@link #LOADABLE} with {@link Loadable#serialize(Object)} or {@link RecordLoadable#serialize(Object, JsonObject)} */
  @Deprecated(forRemoval = true)
