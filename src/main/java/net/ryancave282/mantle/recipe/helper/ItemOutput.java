...
import net.ryancave282.mantle.data.loadable.LoadableCodec;
import net.ryancave282.mantle.data.loadable.Loadables;
import net.ryancave282.mantle.data.loadable.common.ItemStackLoadable;
...
public abstract class ItemOutput implements Supplier<ItemStack> {
  ...
  public enum Loadable implements net.ryancave282.mantle.data.loadable.Loadable<ItemOutput> {
