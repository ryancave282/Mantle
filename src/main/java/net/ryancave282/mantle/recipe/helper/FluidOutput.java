package net.ryancave282.mantle.recipe.helper;
...
import net.ryancave282.mantle.data.loadable.common.FluidStackLoadable;
import net.ryancave282.mantle.data.loadable.common.NBTLoadable;
...
/**
 * Class representing a fluid stack output. Supports both direct stacks and tag output, behaving like {@link FluidIngredient} used for output
 */
public abstract class FluidOutput implements Supplier<FluidStack> {
  ...
  public enum Loadable implements net.ryancave282.mantle.data.loadable.Loadable<FluidOutput> {
