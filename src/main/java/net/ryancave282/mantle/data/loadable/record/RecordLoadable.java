package net.ryancave282.mantle.data.loadable.record;
...
import net.ryancave282.mantle.data.loadable.ErrorFactory;
import net.ryancave282.mantle.data.loadable.Loadable;
import net.ryancave282.mantle.data.loadable.field.DirectField;
import net.ryancave282.mantle.data.loadable.field.LoadableField;
import net.ryancave282.mantle.data.loadable.field.RecordField;
import net.ryancave282.mantle.data.loadable.mapping.CompactLoadable;
import net.ryancave282.mantle.data.loadable.mapping.MappedLoadable;
import net.ryancave282.mantle.data.registry.GenericLoaderRegistry;
 ...
 * Record loaders directly serialize into JSON objects, meaning they are compatible with {@link GenericLoaderRegistry}.
